    ...
    <main className="min-h-screen bg-[#0a0a0a] selection:bg-white/20">
      <section className="relative flex flex-col items-center overflow-hidden px-4 pb-24 pt-40 text-center">
        ...
        <h1 className="mx-auto max-w-3xl text-balance font-serif text-5xl leading-tight tracking-tight sm:text-5xl lg:text-7xl z-10">
          <GrayTitle>Code your dream</GrayTitle>
          <br />
          <BlueTitle>with a single-simple prompt.</BlueTitle>
        </h1>

        <p className="mx-auto mt-6 max-w-xl text-balance text-base leading-relaxed text-white/40 z-10">
          Describe what you have to build, Kodara Agent will choose the
          packages, write the code, and renders a live preview of your app in
          your browser itself.
        </p>
          ...
          <div className="flex h-105">
            ...
            <div className="flex flex-1 flex-col">
              ...
              <div className="flex flex-1 gap-3 overflow-hidden bg-[#141414] p-5">
                {["Todo", "Kode", "Done"].map((col, ci) => (
                  <div key={col} className="flex w-1/3 flex-col gap-2">
                    <div className="mb-1 flex gap-0.5 items-center justify-between">
      ...
      <section className="px-4 pb-32">
        <div className="mx-auto mb-14 max-w-3xl text-center">
          ...
          <SectionHeading gray="Four steps to" blue="a production ready app." />
        </div>
